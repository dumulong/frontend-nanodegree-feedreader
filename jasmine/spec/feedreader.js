 ...
 $(function() {
    ...
    */
    ...
    describe('Initial Entries', function() {
        ...
        /* Return the display back to its original state */
    ...
    describe('New Feed Selection', function() {
         ...
         */
        var oldList; //Variable that will contain the list before the change

        beforeEach(function(done) {
            oldList = $('.feed h2'); //get the current list
            loadFeed(1, done); //Change the feed
        });

        it('should be different after loading new feed', function(done) {
            var newList = $('.feed h2'); //Now get the new list
